...
import { LayoutDashboard, Car, Calendar, Cog, LogOut, FileText } from "lucide-react";
    ...
    <>
      ...
      <div className="hidden md:flex h-full flex-col overflow-y-auto bg-white shadow-sm border-r">
        ...
        <div className="mt-auto p-6">
          <button onClick={onLogout} className="flex items-center gap-x-2 text-slate-500 text-sm font-medium transition-all hover:text-slate-600">
